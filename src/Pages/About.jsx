...
// ============================================================================
// KOMPONEN MEMOIZED (TIDAK ADA PERUBAHAN)
// ============================================================================
...
const StatCard = memo(({ icon: Icon, color, value, label, description, animation, href }) => {
  ...
  return href ? (
    <a href={href} className="block">{CardContent}</a>
  ) : (
    CardContent
  );
});
...
const AboutPage = () => {
  ...
  // Kalkulasi pengalaman kerja (tidak perlu koneksi data)
  ...
  // useEffect untuk inisialisasi AOS dan mengambil semua data dari Supabase
  useEffect(() => {
    AOS.init({ once: false });
    ...
    const fetchAllCounts = async () => {
      try {
        ...
        setTotalCertificates(certificateCount || 0);
  ...
  // Data untuk Stat Cards, sekarang semua dinamis dari state
  const statsData = useMemo(() => [
    ...
    },
    {
      ...
      description: "Sharing insights and knowledge",
      animation: "fade-up",
      href: "/blog", // ⬅ tambahkan ini
    },
    {
      icon: Globe,
      color: "from-[#a855f7] to-[#6366f1]",
  ...
  ], [totalProjects, totalCertificates, totalPosts, YearExperience]);
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7]">
                Hello everyone!, My name is </span><span className="text-white">deniirahman</span>
              <span
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I'm a web developer from Ciamis, West Java. I have 1 year of experience in back-end web development. I really enjoy what I do right now, in my opinion, creating programs is not just a job, but also an art that has aesthetic value.
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/drive/folders/1V644yVqLU_QtKUq8vut7f08GFbbOt8Iq?usp=sharing" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
