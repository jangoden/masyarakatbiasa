...
// Import animation library and its CSS
import AOS from "aos";
...
// ToggleButton component for "See More" / "See Less"
...
// Static data for Tech Stack section
const techStacks = [
...
export default function Portofolio() {
  ...
  // Effect to load data from cache and then fetch fresh data
  useEffect(() => {
  ...
  // Handler for changing tabs by clicking
  const handleChange = (event, newValue) => {
    setValue(newValue);
    if (swiperInstance) {
      swiperInstance.slideTo(newValue); // Tell swiper to slide to the new tab
    }
  };

  // Handler for toggling "See More"
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <Box sx={{ width: "100%" }}>
          ...
          <Tabs
            ...
            sx={{
              ...
              "& .MuiTab-root": {
                ...
                textTransform: "none", transition: "all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",
                padding: "20px 0", zIndex: 1, margin: "8px", borderRadius: "12px",
                "&:hover": {
                  color: "#ffffff", backgroundColor: "rgba(139, 92, 246, 0.1)", transform: "translateY(-2px)",
                  "& .lucide": { transform: "scale(1.1) rotate(5deg)" },
                },
                "&.Mui-selected": {
                  color: "#fff", background: "linear-gradient(135deg, rgba(139, 92, 246, 0.2), rgba(59, 130, 246, 0.2))",
        ...
        {/* Swiper component to handle swipe gestures */}
        <Swiper
          onSwiper={setSwiperInstance}
          onSlideChange={(swiper) => setValue(swiper.activeIndex)} // Update tab when user swipes
          spaceBetween={30}
          slidesPerView={1}
        >
          <SwiperSlide>
